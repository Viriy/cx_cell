...
/*animate.js*/
function newAnimate(box,index){var maindom=$(box).children('.swiper-wrapper').children('.swiper-slide');var nowdom =maindom.eq(index).find('.ani');var befdom =maindom.find('.ani');befdom.attr('style','-webkit-animation:fadeOut 0s 0s both;animation:fadeOut 0s 0s both;visibility: hidden;');for(var i=0;i<nowdom.length;i++){var ani = nowdom.eq(i).data('ani');nowdom.eq(i).attr('style','-webkit-animation:'+ani+';animation:'+ani+';-moz-animation:'+ani+';-ms-animation:'+ani+';-o-animation:'+ani+';visibility: visible;');}}
